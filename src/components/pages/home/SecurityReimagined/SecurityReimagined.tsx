    ...
    <div className="security_reimagined">
      <Container>
        <div className="security_reimagined_in">
          ...
          <ul>
            <li>Imagine a single-elimination bracket with 100,000 players competing head-to-head, winners advancing each round</li>
            <li>Entry fee example: 10 tokens per player</li>
            <li>Resulting prize pool: 1,000,000 tokens up for grabs</li>
            <li>Ultra-fast format: Entire tournament completed with a winner crowned and paid in under 20 minutes</li>
            <li>Influencers and Affiliates  connecting with their community </li>
            <li>Streaming of live tournaments</li>
          </ul>
